...
class SnakeGame:
    def __init__(self, w=640, h=480):
        ...
        #self.taskbar_background=pygame.image.load('taskbar.jpeg')
#        self.taskbar_background=pygame.transform.scale((self.taskbar_background,(self.w,100)))
        self.arrow_images = {
...
#        self.display.blit(self.task_background, (0, 0))
